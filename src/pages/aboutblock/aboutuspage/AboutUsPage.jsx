...
export const AboutUsPage = () => {
    ...
    return (
        <>
            ...
            <span className={styles.subTitleOrange}>Истоки «Жизни»</span>
            <p className={styles.borderLeft}>Экологический Клуб СамГТУ «Жизнь» был образован в 2009 году инициативой
            ...
            <p className={styles.borderLeft}>Первоначальным достижением ЭкоКлуба была разработка студентами проекта
            ...
            <span className={styles.subTitleOrange}>«Возрождение»</span>
            <p className={styles.borderLeft}>В декабре 2016 года началась «реанимация» деятельности ЭкоКлуба. Были организованы
                ...
                среде.</p>
            <p className={styles.borderLeft}>Одной из выпускниц кафедры «Химическая технология и промышленная экология»
            ...
            <p className={styles.borderLeft}>Так как основная часть актива состояла из студентов-экологов 4 курсов, наблюдалась
            ...
            <span className={styles.subTitleOrange}>С чистого листа</span>
            <p className={styles.borderLeft}>Во второй половине 2020 года было решено возобновить работу, но в новом формате и
