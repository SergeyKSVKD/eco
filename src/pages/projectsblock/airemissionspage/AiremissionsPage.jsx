import styles from './AiremissionsPage.module.css'
...
export const AiremissionsPage = () => {
    return (
        <>
            <p className={cn(styles.title)}>Раздел "Выбросы в атмосферу" ожидает идей от студентов и сотрудников.</p>
            <div className={styles.images}            >
                <img src={require('./assets/atmo.webp')} alt="atmo-samgtu" />
            </div>
            <p className={cn(styles.borderLeft, styles.bold)}>А пока призываем к простым действиям:</p>
